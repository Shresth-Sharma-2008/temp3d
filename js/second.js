function button1func(){
    ...
    document.getElementById('vid').classList.add('vidhideani');
    document.getElementById('vid').style.top = '-225vw';
...
function aboutbutton1func(){
    ...
    document.getElementById('buttons').style.top = '25vw';
